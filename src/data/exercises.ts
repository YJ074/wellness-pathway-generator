...
export const BODYWEIGHT_EXERCISES: Record<string, ExerciseType[]> = {
  ...
  advanced: [
    ...
    { 
      ...
      imageUrl: "https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b",
      tutorialUrl: "https://www.youtube.com/watch?v=vq5-vdgJc0I"
    },
    { 
    ...
    { 
      ...
      imageUrl: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158",
      tutorialUrl: "https://www.youtube.com/watch?v=WpEk8mPE2Ch"
    },
    { 
      name: "Jump Lunges", 
      reps: "20 reps (10 each leg)", 
      ...
      imageUrl: "https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b",
      tutorialUrl: "https://www.youtube.com/watch?v=hTdcOG9MGM4"
    }
  ]
};
