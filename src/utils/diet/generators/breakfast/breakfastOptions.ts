...
// Standard breakfast options for vegetarian diets
export const getVegetarianBreakfastOptions = (): string[] => [
...
// Egg breakfast options for non-vegetarian diets
export const getEggBreakfastOptions = (): string[] => [
